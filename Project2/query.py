...
q4 = "SELECT ip_address, COUNT(*) FROM log_table GROUP BY ip_address LIMIT 1"
q5 = "SELECT COUNT(*) AS ff FROM log_table WHERE user_agent CONTAINS 'Mozilla'"
...
q7 = "SELECT COUNT(*) AS requests FROM log_keyspace.log_table WHERE response_size <= 404"
q8 = "SELECT ip_address, COUNT(*) AS count_404 FROM log_keyspace.log_table WHERE status_code = 404 GROUP BY ip_address HAVING COUNT(*) > 10"
